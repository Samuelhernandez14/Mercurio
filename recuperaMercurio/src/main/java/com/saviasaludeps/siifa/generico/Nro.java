...
/**
 *
 * @author Ripalacios Agrupa funciones gen�ricas de validaci�n.
 */
public class Nro {
     ...
     * @return true/false indicando si el valor recibido es o no un double
     * v�lido.
     */
     ...
     * @return true/false indicando si el valor recibido es o no un float
     * v�lido.
     */
    ...
    /**
     * Creaci�n: Ripalacios :: SystemTech Integral :: 28-jul-2005<br>
     * Convierte un String a long. Si el String es null, vacio o no num�rico, lo
     * convierte a cero.
     *
    ...
    /**
     * Creaci�n: Ripalacios :: SystemTech Integral :: 28-jul-2005<br>
     * Convierte un String a entero. Si el String es null, vacio o no num�rico,
     * lo convierte a cero.
     *
    ...
    /**
     * Creaci�n: Ripalacios :: SystemTech Integral :: 9-ago-2005<br>
     * Convierte un String a byte. Si el String es null, vacio o no num�rico, lo
     * convierte a cero.
     *
     * @param valor Valor String a convertir.
     * @return int con el resulatado entero.
    ...
    /**
     * Creaci�n: Ripalacios :: SystemTech Integral :: 9-ago-2005<br>
     * Convierte un String a short. Si el String es null, vacio o no num�rico,
     * lo convierte a cero.
     *
     * @param valor Valor String a convertir.
    ...
    /**
     * Creaci�n: Ripalacios :: SystemTech Integral :: 9-ago-2005<br>
     * Convierte un String a float. Si el String es null, vacio o no num�rico,
     * lo convierte a 0.0
     *
    ...
    /**
     * Creaci�n: Ripalacios :: SystemTech Integral :: 9-ago-2005<br>
     * Convierte un String a double. Si el String es null, vacio o no num�rico,
     * lo convierte a 0.0
     *
     * @param valor Valor a convertir.
